        ...
        <section id="contact" className="relative container py-16 md:py-24">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-8">
                    <div>
                        <h2
                            className="text-3xl md:text-4xl font-bold tracking-tight gradient-text text-glow-cyan mb-4"
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            <div className="p-3 rounded-lg border border-neon-cyan/30 bg-neon-cyan/10 shadow-glow-sm group-hover:shadow-glow-md group-hover:scale-110 transition-all">
                        ...
                        <div className="flex items-center space-x-4 text-muted-foreground group">
                            <div className="p-3 rounded-lg border border-neon-pink/30 bg-neon-pink/10 shadow-glow-pink">
                    ...
                    <div className="hidden md:block relative h-32">
                        <div className="absolute inset-0 bg-gradient-to-r from-neon-cyan/20 via-neon-pink/20 to-neon-purple/20 rounded-lg animate-glow-pulse" />
                        <div className="absolute inset-0 cyber-grid opacity-20 rounded-lg" />
                    </div>
                </div>

                <Card className="shadow-glow-md hover:shadow-glow-lg transition-all duration-500">
                    <CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <input
                                    id="name"
                                    required
                                    className="flex h-12 w-full rounded-md border-2 border-input bg-background/50 px-4 py-2 text-sm transition-all focus-visible:outline-none focus-visible:border-neon-cyan focus-visible:shadow-glow-md disabled:cursor-not-allowed disabled:opacity-50"
                                    value={formData.name}
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    id="message"
                                    required
                                    className="flex min-h-[140px] w-full rounded-md border-2 border-input bg-background/50 px-4 py-3 text-sm transition-all focus-visible:outline-none focus-visible:border-neon-cyan focus-visible:shadow-glow-md disabled:cursor-not-allowed disabled:opacity-50 resize-none"
